...
const ProductCard = ({ product, index, setSelectedProductForSpecs }) => {
  ...
  const getWhatsAppLink = () => {
    let msg = `Hi Mantse Electronics, I am inquiring about the price and availability of the ${product.name}`;
    if (selectedVariant) {
      msg += ` (${selectedVariant})`;
            ...
            {filteredProducts.length > 0 ? (
              ...
              >
                <div className="empty-state-content">
                  ...
                  <a href={`https://wa.me/233240000000?text=${encodeURIComponent(`Hi Mantse Electronics, do you have any new stock arriving for ${activeCategory}?`)}`} target="_blank" rel="noopener noreferrer" className="whatsapp-cta-link">
